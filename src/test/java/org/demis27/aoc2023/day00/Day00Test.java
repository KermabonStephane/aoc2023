...
public class Day00Test {
    ...
    void day00_part1_sample() throws IOException {
        ...
        long result = day00.processPartOne("day09-part1-sample.txt");
    ...
    void day00_part2_sample() throws IOException {
        Day00 day00 = new Day00();
        long result = day00.processPartTwo("day09-part2-sample.txt");
        Assertions.assertEquals(0, result);
    }
    @Test
    void day00_part1() throws IOException {
        Day00 day00 = new Day00();
        long result = day00.processPartOne("day09.txt");
        Assertions.assertEquals(0, result);
    }
    ...
    void day00_part2() throws IOException {
        Day00 day00 = new Day00();
        long result = day00.processPartTwo("day09.txt");
        Assertions.assertEquals(0, result);
    }
